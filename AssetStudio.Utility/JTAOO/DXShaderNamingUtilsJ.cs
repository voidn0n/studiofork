...
{
    public static class DXShaderNamingUtilsJ
    {
        ...
        public static string GetConstantBufferParamTypeName(NumericShaderParameterJ param) => GetConstantBufferParamTypeName(param.RowCount, param.ColumnCount, param.Type, true);
