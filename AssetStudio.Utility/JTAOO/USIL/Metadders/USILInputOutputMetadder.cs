...
namespace ShaderLabConvert
{
	public class USILInputOutputMetadder : IUSILOptimizer
	{
		...
		private void UseMetadata(USILOperand operand)
		{
			...
			else if (DXShaderNamingUtilsJ.HasSpecialInputOutputName(operand.operandType))
			{
				string name = DXShaderNamingUtilsJ.GetSpecialInputOutputName(operand.operandType);
